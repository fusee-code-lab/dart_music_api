...
abstract class $AlbumCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, String coverImageUrl});
}
...
class _$AlbumImpl implements _Album {
  const _$AlbumImpl(
      {required this.id, required this.name, required this.coverImageUrl});
  ...
  @override
  String toString() {
    return 'Album(id: $id, name: $name, coverImageUrl: $coverImageUrl)';
  }
...
abstract class _Album implements Album {
  const factory _Album(
      ...
      required final String coverImageUrl}) = _$AlbumImpl;
